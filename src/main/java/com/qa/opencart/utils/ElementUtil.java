...
//	}
	 ...
	 * @return
	 */
	public List<WebElement> waitForElementsVisible(By productLocator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
		return wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(productLocator));
	}
